      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-6 mb-8 border border-purple-100">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-4 text-lg border border-gray-200 rounded-xl focus:ring-2 focus:ring-[#404e7a] focus:border-transparent outline-none transition-all duration-200"
            />
          </div>
        </div>
        ...
        {/* <div className="bg-white rounded-2xl shadow-xl p-6 border border-purple-100">
          <div className="flex items-center mb-6">
            <Filter className="text-[#404e7a] mr-2" size={20} />
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div>
              <label className="flex items-center mb-3 text-sm font-medium text-gray-700">
                <Building className="mr-2 text-[#404e7a]" size={16} />
                Construction Type
              </label>
              <select
                ...
                className="w-full px-4 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-[#404e7a] focus:border-transparent outline-none transition-all duration-200"
              >
            ...
            <div>
              <label className="flex items-center mb-3 text-sm font-medium text-gray-700">
                <MapPin className="mr-2 text-[#404e7a]" size={16} />
                Location
              </label>
              <select
            ...
            <div>
              <label className="flex items-center mb-3 text-sm font-medium text-gray-700">
                <Users className="mr-2 text-[#404e7a]" size={16} />
                Company Size
              </label>
              <select
          ...
          <div className="mt-6 text-center">
            <button
              ...
              style={{
                background: "linear-gradient(135deg, #4d5e99ff 0%, #404e7a 100%)",
              }}
            >
              Apply Filters
            </button>
